...
if x==5:
    ...
    st.image("./images/71pys4B4OVL._AC_UF1000,1000_QL80_.jpg")
elif x == 14:
    st.write("Created GrEG, a CV model that can detect if an image came from 6 countries, with my team at AI Camp")
    st.image("./images/Quality_Quesadillas.png")
    st.write("Passed USACO Bronze")
elif x == 15:
    st.write("AI Camp Internship")
    st.image("./images/12b467_a4ceef0f338c41c7885cb083ea36a00f~mv2_d_1742_1743_s_2.png")
